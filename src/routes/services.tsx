...
const services = [
  ...
  { Icon: ChefHat, title: "Cloud Kitchen Franchise", text: "Complete cloud kitchen solutions including setup support, food production assistance, packaging, and operational guidance to help businesses launch and grow efficiently." },
